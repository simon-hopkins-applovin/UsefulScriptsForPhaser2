...
function ZumaBall(aGame, aParent, aName, aAddToStage, aEnableBody, aPhysicsBodyType) {
	...
	var __baseVisual = this.game.add.sprite(-4.0, -4.0, 'square', null, __bottleParent);
	__baseVisual.anchor.set(0.5, 0.5);
	
	var __glowVisual = this.game.add.sprite(-4.0, -4.0, 'square', null, __bottleParent);
	__glowVisual.anchor.set(0.5, 0.5);
	
	var __overlay = this.game.add.sprite(-4.0, -4.0, 'square', null, __bottleParent);
